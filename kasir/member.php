...
<div class="container mx-auto p-4 mt-[2%]">
    ...
    <div class="container mx-auto p-4">
        ...
        <form  method="post">
            ...
            <a href="../view/add_member_kasir.php" class="bg-[#53D258] hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
                + Tambah Data
            </a >
        </div>
                ...
                <tbody id="searchResults">
                    <tr>
                        ...
                        <th class="border-t border-gray-300 px-4 py-2">
                           <a href="../view/update_member_kasir.php?id_member=<?= $row['id_member'] ?>">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <a href="../delete/delete_member_kasir.php?id_member=<?= $row['id_member'] ?>">
