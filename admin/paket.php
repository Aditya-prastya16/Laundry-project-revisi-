...
<div class="container mx-auto p-4">
    <!-- Search and Add Data -->
    <p class="font-semibold text-[22px] mb-[1%]">Data Paket </p>
    <div class="flex justify-between mb-4">
        ...
        <!-- Tombol Tambah Data -->
        <a href="../view/add_paket_admin.php" class="bg-[#53D258] hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
            + Tambah Data
        </a>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th class="border-t border-gray-300 px-4 py-2">
                            ...
                            <?php
                                // Periksa apakah paket bisa dihapus
                                $id = $row['id_paket'];
    ...
    <div class="flex justify-between mb-4 my-[2%]">
        ...
        <!-- Informasi Halaman -->
        <p>Page <?php echo $page; ?> of <?php echo $jumlahPage ?></p>
    </div>
</div>
<?php
                        }
