<?php
    ...
    include "./live-src/function/functionoutlet.php";
    ...
    $outlet = mysqli_query($koneksi, "SELECT * FROM tb_outlet ORDER BY id_outlet ASC LIMIT ".$limitStart.", ".$limit);
    $nomor = 1;
    $no = $limitStart + 1;
    if( isset($_POST["cari"]) ) {
...
<div class="container mx-auto p-4 mt-[2%]">
    ...
    <div class="container mx-auto p-4">
        <!-- Search and Add Data -->
        <p class="font-semibold text-[22px] mb-[1%]">Data Outlet </p>
        ...
        <form  method="post">
            <input class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="search" placeholder="Cari Data Outlet" name="keyword" id="keyword">
        </form>
            </div>
            <a href="../view/add_outlet_admin.php" class="bg-[#53D258] hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
                + Tambah Data
            </a >
        </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <a href="../delete/delete_outlet_admin.php?id_outlet=<?= $row['id_outlet'] ?>">
...
<?php
      $SqlQuery = mysqli_query($koneksi, "SELECT * FROM tb_outlet");        
    ...
    <li <?php echo $linkActive; ?>>
      <a href="outlet.php?page=<?php echo $page; ?>" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"><?php echo $page; ?></a>
    </li>
    <?php       
      if($page == $jumlahPage){ 
      ?>
    ...
    <script src="./live-src/js/ajaxoutlet.js"></script>
    <?= template_footer() ?>