<?php
 ...
 $page = (isset($_GET['page']))? (int) $_GET['page'] : 1;
    ...
    $user = mysqli_query($koneksi, "SELECT * FROM tb_user ORDER BY id_user ASC LIMIT ".$limitStart.", ".$limit);
    $nomor = 1;
    $no = $limitStart + 1;
    if( isset($_POST["cari"]) ) {
...
<div class="container mx-auto p-4">
    <!-- Search and Add Data -->
    <p class="font-semibold text-[22px] mb-[1%]">Data User </p>
    <div class="flex justify-between mb-4">
        ...
        <a href="../view/add_user_admin.php" class="bg-[#53D258] hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
            + Tambah Data
        </a >
    </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <a href="../delete/delete_user_admin.php?id_user=<?= $row['id_user'] ?>">
