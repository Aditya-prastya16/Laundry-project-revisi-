...
<script>
        ...
        const config = {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Total Member Transaction Per Month',
                    data: data,
                    fill: false,
                    backgroundColor: [
                                            'rgba(290, 99, 132, 0.2)',
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Member Transactions per Month'
                    }
                }
            },
        };
...
<script>
    ...
    const config2 = {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Member Transaction Per Month'
                }
            }
        },
    };
    ...
    <div class="flex items-center">
        <p class="font-semibold text-[20px]">Data Member</p>
    </div>
